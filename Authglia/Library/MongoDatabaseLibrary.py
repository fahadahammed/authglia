...
MCONN = pymongo.MongoClient(app.config["AUTHGLIA_DB_HOST"], app.config["AUTHGLIA_DB_PORT"], connect=False)


class MongoOperations:
    def __init__(self, collection_name=None):
        self.client = MCONN
        database_name = str(app.config["Authglia_DB_NAME"]).lower()
...
class DynamicName:
    def __init__(self):
        ...
        self.collection_name = "Authglia" + str(self.str_year_month)
        self.database_name = "AUTHGLIA" + str(self.str_year)
