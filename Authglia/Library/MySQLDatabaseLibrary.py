...
class ConnectMySQL:
    def __init__(self):
        self.db = MySQLdb.connect(host=app.config.get("AUTHGLIA_DB_HOST"),  # your host
                             user=app.config.get("AUTHGLIA_DB_USER"),       # username
                             passwd=app.config.get("AUTHGLIA_DB_PASSWORD"),     # password
                             db=app.config.get("AUTHGLIA_DB_NAME"),   # name of the database
                             port=app.config.get("AUTHGLIA_DB_PORT"),
                             use_unicode=True,
                             charset="utf8mb4"
        )
        self.db.commit()
